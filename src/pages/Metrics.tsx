    ...
    <div className="pt-24 pb-32 min-h-screen bg-white">
      ...
      <header className="max-w-7xl mx-auto px-6 mb-16">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          <div className="max-w-2xl animate-in fade-in slide-in-from-left-8 duration-1000">
            <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 text-[9px] font-black tracking-[0.4em] uppercase bg-black text-white rounded-md shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-right-8 duration-1000">
            <button className="bg-green-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-black text-[10px] md:text-[11px] uppercase tracking-widest shadow-xl shadow-green-700/20 hover:-translate-y-1 transition-all active:scale-95">
              Request a Demo
            </button>
            <button className="bg-green-950 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-black text-[10px] md:text-[11px] uppercase tracking-widest shadow-xl shadow-green-950/20 hover:-translate-y-1 transition-all active:scale-95">
              Download Report
            </button>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <section className="lg:col-span-8 bg-green-50/30 rounded-[2.5rem] p-8 md:p-10 border border-green-100 shadow-sm animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <aside className="lg:col-span-4 bg-green-900 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden animate-in fade-in slide-in-from-right-8 duration-700">
        ...
        <section className="bg-white rounded-[3rem] p-8 md:p-12 border border-green-100 shadow-sm animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-green-50/50 p-6 rounded-2xl flex items-center gap-6 group hover:bg-green-50 transition-colors">
            ...
            <div className="bg-green-50/50 rounded-[3rem] p-10 border border-green-100 flex flex-col items-center justify-center text-center">
              ...
              <button className="w-full bg-green-600 text-white py-5 rounded-xl font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl shadow-green-600/20 hover:brightness-110 transition-all active:scale-95">
